...
int main(int argc, char **argv) {
    ...
    if (argc >= 2) {
        ...
        if (strcmp(argv[1], "bridge") == 0 && argc == 7) {
            ...
            printf("  Δ(R12=R5, R51=R2, R52=R1) → Y:\n");
            printf("\n");
            printf("  变换前:\n");
            printf("\n");
            printf("  ┌──R1──C──R3──┐\n");
            ...
            printf("  └──R2──D──R4──┘\n");
            printf("\n");
            printf("  R1="); frac_print(r1); printf("  R3="); frac_print(r3); printf("\n");
            printf("  R5="); frac_print(r5); printf("\n");
            printf("  R2="); frac_print(r2); printf("  R4="); frac_print(r4); printf("\n");
            printf("\n");
            printf("  变换后 (Δ→Y):\n");
            DeltaWye dw = delta_to_wye(r1, r2, r5);
            printf("                 ┌── R2 ── C ── R3 ──┐\n");
            ...
            printf("             R2 = "); frac_print(dw.r1); printf("  R3 = "); frac_print(r3); printf("\n");
            printf("             R1 = "); frac_print(dw.r3); printf("  R4 = "); frac_print(r4); printf("\n");
